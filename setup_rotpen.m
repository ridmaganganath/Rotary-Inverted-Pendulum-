%% SETUP_ROTPEN
%
% Sets the necessary parameters to run the Rotary Inverted Pendulum 
% laboratory.
% 
...
% Is servo equipped with Tachometer? (i.e. option T): set to 'YES' or 'NO'
TACH_OPTION = 'NO';
% Type of Load: set to 'NONE', 'DISC', or 'BAR' (set to NONE when using module)
LOAD_TYPE = 'NONE';
% Amplifier Gain used: 
...
[ g, Mr, Lr, lr, Jr, Dr ] = config_sp( 'ROTARY_ARM' );
% Load medium 12-inch pendulum parameters
[ g, Mp, Lp, lp, Jp, Dp ] = config_sp( 'MEDIUM_12IN');
% Set open-loop state-space model of rotary inverted pendulum
